...
tagsInput.directive('tagsInput', ["$timeout","$document","tagsInputConfig", function($timeout, $document, tagsInputConfig) {
    function TagList(options, events) {
        ...
        self.cancelEdit = function() {
            self.selectedTag.text = self._undoValue;
        ...
        self.selectTag = function(item) {
            ...
            // deselct on enter, if in editing
            self.selectedTag = item;
            self._undoValue = item.text;
            self._isEdit = true;
            
            // events.trigger('tag-edit', { $tag: item });
        }
